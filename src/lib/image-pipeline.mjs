...
const BUNNY_STORAGE_ZONE = process.env.BUNNY_STORAGE_ZONE || 'keepers-flame';
const BUNNY_API_KEY = process.env.BUNNY_API_KEY || '';
const BUNNY_PULL_ZONE_URL = process.env.BUNNY_PULL_ZONE_URL || 'https://keepers-flame.b-cdn.net';
